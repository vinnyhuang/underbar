(function() {
  ...
  _.indexOf = function(array, target){
    ...
    _.each(array, function(item, index) {
      if(Array.isArray(target) && Array.isArray(item) && result === -1) {
        if (arraysEqual(target, item))
          result = index;
      }
      else if (item === target && result === -1) {
        result = index;
      }
    });
  ...
  _.reduce = function(collection, iterator, accumulator) {
    var noacc = accumulator === undefined;
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      //console.log(args);
      var index = _.indexOf(calledArgs, args)
      if(index === -1) {
